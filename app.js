/* Позиции плиток в сетке 5×5 (строка, колонка).
   Центральный блок занимает строки 2–3, колонки 2–4 (см. .center в styles.css).
   Всего 19 ячеек: 5 + 2 + 2 + 5 + 5. */
const LAYOUT = {
  1:  [1, 1], 2:  [1, 2], 3:  [1, 3], 4:  [1, 4], 5:  [1, 5],
  6:  [2, 1],                                     7:  [2, 5],
  8:  [3, 1],                                     9:  [3, 5],
  10: [4, 1], 11: [4, 2], 12: [4, 3], 13: [4, 4], 14: [4, 5],
  15: [5, 1], 16: [5, 2], 17: [5, 3], 18: [5, 4], 19: [5, 5],
};
